...
import type { Exercise, DayOfWeek, WorkoutGoal } from "@fittracker/types";
...
export default function NewWorkoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await workoutsApi.create(user.profileId, {
        name,
        goal,
        days: selectedDays,
  ...
  return (
    <div className="page-container max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-surface-900">New Workout</h1>
      </div>
